...
const Hero = () => {
  return (
    <section className="relative h-screen flex items-center justify-center bg-nature-light">
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-r from-nature-dark/70 to-nature-dark/50 z-10"></div>
        <img 
      ...
      <div className="container-custom relative z-20 text-center px-4">
        <h1 className="h1 text-white mb-6 animate-fade-in">Pure Organic Products</h1>
